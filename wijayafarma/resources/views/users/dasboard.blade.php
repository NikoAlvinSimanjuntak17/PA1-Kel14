        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="m-b-40">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
   Delectus unde mollitia dignissimos quos obcaecati
  minima inventore odit at officia dicta. Adipisci cupiditate
   mollitia atque magnam labore sed enim minus maxime?</p>
              <p><a class="btn btn-lg btn-circle btn-outline-new-white" href="#">About</a></p>
            </div>
          </div>
        </div>
      </li>
